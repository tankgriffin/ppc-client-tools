  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'xs': ['0.75rem', { lineHeight: '1rem' }],     // 12px - Captions and labels
        'sm': ['0.875rem', { lineHeight: '1.25rem' }], // 14px - Secondary text
        'base': ['1rem', { lineHeight: '1.5rem' }],    // 16px - Standard text
        'lg': ['1.125rem', { lineHeight: '1.75rem' }], // 18px - Important content
        'xl': ['1.25rem', { lineHeight: '1.75rem' }],  // 20px - Card titles
        '2xl': ['1.5rem', { lineHeight: '2rem' }],     // 24px - Subsection headers
        '3xl': ['2rem', { lineHeight: '2.25rem' }],    // 32px - Section headers
        '4xl': ['2.5rem', { lineHeight: '2.5rem' }],   // 40px - Page titles
      },
      spacing: {
        // Component spacing from PRD
        'xs': '0.25rem',  // 4px
        'sm': '0.5rem',   // 8px
        'md': '1rem',     // 16px
        'lg': '1.5rem',   // 24px
